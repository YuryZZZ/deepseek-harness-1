...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/langfuse/langfuse': { kind: 'indirect', reason: 'The service interface delegates all model rendering to dsh-tool-langfuse.' },
  'packages/langfuse/langfuse-ingest': { kind: 'indirect', reason: 'The session-telemetry backend forwards captured records outward and registers no model surface.' },
